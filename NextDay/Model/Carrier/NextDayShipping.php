 ...
 */
class NextDayShipping extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $this->_logger = $logger;
        $this->_logger->debug('**************************');
        $this->_logger->debug('NextDayShipping');

        $this->_logger->debug('NextDayShipping - getConfigFlag');
        $this->_logger->debug($this->getConfigFlag('active'));

        if (!$this->getConfigFlag('active')) {
            $this->_logger->debug('NextDayShipping - No pasó el config flag');
            return false;
        }
        ...
        try{
            ...
            $this->_logger->debug('NextDayShipping - data');
            ...
            $this->_logger->debug('NextDayShipping - request');
            ...
            $this->_logger->debug('NextDayShipping - response');
            ...
            $this->_logger->debug('NextDayShipping - EXCEPTION');
